...
if __name__ == '__main__':
    ...
    x_data_train = x_data_train.unsqueeze(1)
    ...
    for step,(batch_x,batch_y) in enumerate(my_dataloader):
        ...
        for index , i in enumerate(out):
            ...
            if loss == 0:
                num_success += 1
    print(f"准确率为{num_success/num_total}")
